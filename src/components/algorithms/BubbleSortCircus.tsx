...
const BubbleSortCircus: React.FC = () => {
  ...
  const bubbleSort = async (): Promise<void> => {
    ...
    try {
      ...
      console.error('Error in bubbleSort:', err);
    } finally {
      setIsSorting(false);
    }
  };
  ...
  return (
    <div className='relative w-full h-full overflow-hidden'>
      ...
      <div className='absolute top-4 left-4 bg-white bg-opacity-75 p-4 rounded shadow'>
        <h2 className='text-2xl font-bold mb-4'>Bubble Sort </h2>
...
export default BubbleSortCircus;
